...
public class AddEditAlarmActivity  extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        lable = (EditText) findViewById(R.id.edit_alarm_label);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_delete:
                if (getAlarm().getId() == 1 || getAlarm().getId() == 2){
                    Toast.makeText(this, R.string.default_alarm_delete_warning, Toast.LENGTH_SHORT).show();
                }else{
                    delete();
                }
    ...
    private void save() {
        ...
        alarm.setLabel(lable.getText().toString());
        ...
        final int rowsUpdated = AlarmDatabaseHelper.getInstance(AddEditAlarmActivity.this).updateAlarm(alarm);
    ...
    private void delete() {
        ...
        builder.setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                final int rowsDeleted = AlarmDatabaseHelper.getInstance(AddEditAlarmActivity.this).deleteAlarm(alarm);
                int messageId;
                if(rowsDeleted == 1) {
